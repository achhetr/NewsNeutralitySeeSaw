...
print(' check')
print(os.path.isdir(os.path.join(dir_cwd,user)))
if not os.path.isdir(os.path.join(dir_cwd,user)):
    print('Directory created: ' + user)
    os.makedirs(os.path.join(dir_cwd,user))
else:
